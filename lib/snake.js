...
Snake.prototype.move = function(direction) {
    if (direction === '38' || direction === 'up') { //up
       if (this.canMoveDown()) {
            this.moveOnYAxis(this.velocity * -1);
       }
    }
    else if (direction === '40' || direction === 'down') { //down
        if (this.canMoveUp()) {
            this.moveOnYAxis(this.velocity);
        }
    }
    else if (direction === '37' || direction === 'left') { //left
        if (this.canMoveLeft()) {
            this.moveOnXAxis(this.velocity * -1);
        }
    }
    else if (direction === '39' || direction === 'right') { //right

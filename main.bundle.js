...
/***/ function(module, exports) {
	...
	/******/return __webpack_require__(0); /******/})( /************************************************************************/ /******/[ /* 0 */function(module,exports,__webpack_require__){__webpack_require__(1);(function webpackMissingModule(){throw new Error("Cannot find module \"index.js\"");})();module.exports = __webpack_require__(8); /***/}, /* 1 */function(module,exports,__webpack_require__){'use strict';__webpack_require__(2); /***/}, /* 2 */function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var Snake=__webpack_require__(6).Snake;var Food=__webpack_require__(5).Food;var canvas=document.getElementById('canvas');var context=canvas.getContext('2d');var board=new Board(600,300);var snake=new Snake(board);var food=new Food(board);function overlay(){var el=document.getElementById("overlay");el.style.visibility = el.style.visibility == "visible"?"hidden":"visible";}$('#play-again').click(function(){console.log("RELOAD GAME");window.location.reload();});var direction='0';requestAnimationFrame(function gameLoop(){context.clearRect(0,0,canvas.width,canvas.height);board.draw(context);food.draw(context);document.onkeydown = function(e){if(e.keyCode === 37 || e.keyCode === 38 || e.keyCode === 39 || e.keyCode === 40){direction = e.keyCode.toString();}};if(snake.collisionAtEdge() || snake.collisionWithSelf(direction)){return overlay();}snake.move(direction);requestAnimationFrame(gameLoop);}); /***/}, /* 3 */function(module,exports){'use strict';function Block(board,x,y){this.board = board;this.x = x;this.y = y;this.width = 40;this.height = 10;}Block.prototype.draw = function(context){context.beginPath();context.rect(this.x,this.y,this.width,this.height); // context.arc(this.x, this.y, 10, 0, 2 * Math.PI, false);
	context.fillStyle = 'orange';context.fill();return this;};Block.prototype.blockBelow = function(){return this.board.findBlock(this.x,this.y + 1);};Block.prototype.blockToTheRight = function(){return this.board.findBlock(this.x + 1,this.y);};module.exports = {Block:Block}; /***/}, /* 4 */function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Food=__webpack_require__(5).Food;function Board(columns,rows){this.columns = columns;this.rows = rows;this.blocks = [];this.food = [];this.score = 0;}Board.prototype.draw = function(context){this.blocks.forEach(function(block){block.draw(context);});};Board.prototype.findBlock = function(x,y){for(var i=0;i < this.blocks.length;i++) {if(this.blocks[i].x === x && this.blocks[i].y === y){return this.blocks[i];}}};Board.prototype.addBlock = function(x,y){var block=new Block(this,x,y);this.blocks.push(block);return block;};Board.prototype.addFood = function(food){this.food.push(food);};module.exports = {Board:Board}; /***/}, /* 5 */function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var Snake=__webpack_require__(6).Snake; //image = 'mouse.png';
	function Food(board){this.board = board;this.width = 10;this.height = 10;this.setRandomPosition();this.board.addFood(this);}Food.prototype.draw = function(context){context.beginPath();context.arc(this.x,this.y,6,0,2 * Math.PI,false);context.lineWidth = 2;context.fillStyle = 'green';context.fill();return this;};Food.prototype.setRandomPosition = function(){this.x = Math.floor(Math.random() * 560 - 20 + 20);this.y = Math.floor(Math.random() * 260 - 20 + 20);};Food.prototype.wasEaten = function(){this.setRandomPosition();};module.exports = {Food:Food}; /***/}, /* 6 */function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var $=__webpack_require__(7);function Snake(board){this.board = board;this.body = [new Block(board,40,40)];this.head = this.body[0];this.board.blocks.push(this.head);this.velocity = 3;return this;}Snake.prototype.move = function(direction){if(direction == '38'){ //down
	if(this.canMoveDown()){this.moveOnYAxis(this.velocity * -1);}}else if(direction == '40'){ //up
	if(this.canMoveUp()){this.moveOnYAxis(this.velocity);}}else if(direction == '37'){ //left
	if(this.canMoveLeft()){this.moveOnXAxis(this.velocity * -1);}}else if(direction == '39'){ //right
	if(this.canMoveRight()){this.moveOnXAxis(this.velocity);}}};Snake.prototype.canMoveUp = function(){return !(this.isAtTop() || this.blockBelow());};Snake.prototype.canMoveDown = function(){return !(this.isAtBottom() || this.blockOnTop());};Snake.prototype.canMoveRight = function(){return !(this.isAtRightEdge() || this.blockToTheRight());};Snake.prototype.canMoveLeft = function(){return !(this.isAtLeftEdge() || this.blockToTheLeft());};Snake.prototype.isAtRightEdge = function(){return this.head.x + 10 > this.board.columns;};Snake.prototype.isAtLeftEdge = function(){return this.head.x - 1 < 0;};Snake.prototype.isAtBottom = function(){return this.head.y - 1 < 0;};Snake.prototype.isAtTop = function(){return this.head.y + 10 > this.board.rows;};Snake.prototype.blockToTheLeft = function(){return !!this.board.findBlock(this.head.x - 2,this.head.y);};Snake.prototype.blockToTheRight = function(){return !!this.board.findBlock(this.head.x + 2,this.head.y);};Snake.prototype.blockOnTop = function(){return !!this.board.findBlock(this.head.x,this.head.y - 2);};Snake.prototype.blockBelow = function(){return !!this.board.findBlock(this.head.x,this.head.y + 2);};Snake.prototype.draw = function(){context.fillRect(this.head.x,this.head.y,this.head.width,this.head.height);return this;};Snake.prototype.moveOnXAxis = function(velocity){var snakeLength=this.body.length;for(var i=1;i < snakeLength;i++) {this.body[snakeLength - i].x = this.body[snakeLength - i - 1].x;this.body[snakeLength - i].y = this.body[snakeLength - i - 1].y;}this.head.x += velocity;this.headCheckForFood();};Snake.prototype.moveOnYAxis = function(velocity){var snakeLength=this.body.length;for(var i=1;i < snakeLength;i++) {this.body[snakeLength - i].x = this.body[snakeLength - i - 1].x;this.body[snakeLength - i].y = this.body[snakeLength - i - 1].y;}this.head.y += velocity;this.headCheckForFood();};Snake.prototype.collisionAtEdge = function(){return this.isAtTop() || this.isAtBottom() || this.isAtLeftEdge() || this.isAtRightEdge();};Snake.prototype.collisionWithSelf = function(direction){if(direction === '39' && this.blockToTheRight()){return true;}else if(direction === '37' && this.blockToTheLeft()){return true;}else if(direction === '38' && this.blockOnTop()){return true;}else if(direction === '40' && this.blockBelow()){return true;}};Snake.prototype.headCheckForFood = function(){var xDiff=Math.abs(this.head.x - this.board.food[0].x);var yDiff=Math.abs(this.head.y - this.board.food[0].y);if(xDiff < 10 && yDiff < 10){for(var i=0;i < 15;i++) {this.eat(new Block(this.board,this.body[0].x,this.body[0].y));}this.board.food[0].wasEaten();this.board.score += 100;$('span').text(this.board.score);}};Snake.prototype.eat = function(block){this.body.push(block);this.board.blocks.push(block);};module.exports = {Snake:Snake}; /***/}, /* 7 */function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__; /*!
		 * jQuery JavaScript Library v2.1.4
		 * http://jquery.com/
		 *
		 * Includes Sizzle.js
	...
	// you try to trace through "use strict" call chains. (#13335)
	//
	var arr=[];var _slice3=arr.slice;var concat=arr.concat;var push=arr.push;var indexOf=arr.indexOf;var class2type={};var toString=class2type.toString;var hasOwn=class2type.hasOwnProperty;var support={};var  // Use the correct document accordingly with window argument (sandbox)
	...
	length:0,toArray:function toArray(){return _slice3.call(this);}, // Get the Nth element in the matched element set OR
	// Get the whole matched element set as a clean array
	get:function get(num){return num != null? // Return just the one element from the set
	num < 0?this[num + this.length]:this[num]: // Return all the elements in a clean array
	_slice3.call(this);}, // Take an array of elements and push it onto the stack
	// (returning the new matched element set)
	...
	// (You can seed the arguments with an array of args, but this is
	// only used internally.)
	each:function each(callback,args){return jQuery.each(this,callback,args);},map:function map(callback){return this.pushStack(jQuery.map(this,function(elem,i){return callback.call(elem,i,elem);}));},slice:function slice(){return this.pushStack(_slice3.apply(this,arguments));},first:function first(){return this.eq(0);},last:function last(){return this.eq(-1);},eq:function eq(i){var len=this.length,j=+i + (i < 0?len:0);return this.pushStack(j >= 0 && j < len?[this[j]]:[]);},end:function end(){return this.prevObject || this.constructor(null);}, // For internal use only.
	// Behaves like an Array's method, not like a jQuery method.
	...
	args = _slice3.call(arguments,2);proxy = function(){return fn.apply(context || this,args.concat(_slice3.call(arguments)));}; // Set the guid of unique handler to the same of original handler, so it can be removed
	...
	guaranteedUnique={children:true,contents:true,next:true,prev:true};jQuery.extend({dir:function dir(elem,_dir3,until){var matched=[],truncate=until !== undefined;while((elem = elem[_dir3]) && elem.nodeType !== 9) {if(elem.nodeType === 1){if(truncate && jQuery(elem).is(until)){break;}matched.push(elem);}}return matched;},sibling:function sibling(n,elem){var matched=[];for(;n;n = n.nextSibling) {if(n.nodeType === 1 && n !== elem){matched.push(n);}}return matched;}});jQuery.fn.extend({has:function has(target){var targets=jQuery(target,this),l=targets.length;return this.filter(function(){var i=0;for(;i < l;i++) {if(jQuery.contains(this,targets[i])){return true;}}});},closest:function closest(selectors,context){var cur,i=0,l=this.length,matched=[],pos=rneedsContext.test(selectors) || typeof selectors !== "string"?jQuery(selectors,context || this.context):0;for(;i < l;i++) {for(cur = this[i];cur && cur !== context;cur = cur.parentNode) { // Always skip document fragments
	...
	_fired3, // Flag to know if list is currently firing
	...
	fire=function fire(data){memory = options.memory && data;_fired3 = true;firingIndex = firingStart || 0;firingStart = 0;firingLength = list.length;firing = true;for(;list && firingIndex < firingLength;firingIndex++) {if(list[firingIndex].apply(data[0],data[1]) === false && options.stopOnFalse){memory = false; // To prevent further calls using add
	...
	fireWith:function fireWith(context,args){if(list && (!_fired3 || stack)){args = args || [];args = [context,args.slice?args.slice():args];if(firing){stack.push(args);}else {fire(args);}}return this;}, // Call all the callbacks with the given arguments
	fire:function fire(){self.fireWith(this,arguments);return this;}, // To know if the callbacks have already been called at least once
	fired:function fired(){return !!_fired3;}};return self;};jQuery.extend({Deferred:function Deferred(func){var tuples=[ // action, add listener, listener list, final state
	["resolve","done",jQuery.Callbacks("once memory"),"resolved"],["reject","fail",jQuery.Callbacks("once memory"),"rejected"],["notify","progress",jQuery.Callbacks("memory")]],_state3="pending",_promise3={state:function state(){return _state3;},always:function always(){deferred.done(arguments).fail(arguments);return this;},then:function then() /* fnDone, fnFail, fnProgress */{var fns=arguments;return jQuery.Deferred(function(newDefer){jQuery.each(tuples,function(i,tuple){var fn=jQuery.isFunction(fns[i]) && fns[i]; // deferred[ done | fail | progress ] for forwarding actions to newDefer
	deferred[tuple[1]](function(){var returned=fn && fn.apply(this,arguments);if(returned && jQuery.isFunction(returned.promise)){returned.promise().done(newDefer.resolve).fail(newDefer.reject).progress(newDefer.notify);}else {newDefer[tuple[0] + "With"](this === _promise3?newDefer.promise():this,fn?[returned]:arguments);}});});fns = null;}).promise();}, // Get a promise for this deferred
	// If obj is provided, the promise aspect is added to the object
	promise:function promise(obj){return obj != null?jQuery.extend(obj,_promise3):_promise3;}},deferred={}; // Keep pipe for back-compat
	_promise3.pipe = _promise3.then; // Add list-specific methods
	jQuery.each(tuples,function(i,tuple){var list=tuple[2],stateString=tuple[3]; // promise[ done | fail | progress ] = list.add
	_promise3[tuple[1]] = list.add; // Handle state
	if(stateString){list.add(function(){ // state = [ resolved | rejected ]
	_state3 = stateString; // [ reject_list | resolve_list ].disable; progress_list.lock
	},tuples[i ^ 1][2].disable,tuples[2][2].lock);} // deferred[ resolve | reject | notify ]
	deferred[tuple[0]] = function(){deferred[tuple[0] + "With"](this === deferred?_promise3:this,arguments);return this;};deferred[tuple[0] + "With"] = list.fireWith;}); // Make the deferred a promise
	_promise3.promise(deferred); // Call given func if any
	if(func){func.call(deferred,deferred);} // All done!
	return deferred;}, // Deferred helper
	when:function when(subordinate /* , ..., subordinateN */){var i=0,resolveValues=_slice3.call(arguments),length=resolveValues.length, // the count of uncompleted subordinates
	remaining=length !== 1 || subordinate && jQuery.isFunction(subordinate.promise)?length:0, // the master Deferred. If resolveValues consist of only a single Deferred, just use that.
	deferred=remaining === 1?subordinate:jQuery.Deferred(), // Update function for both resolve and progress values
	updateFunc=function updateFunc(i,contexts,values){return function(value){contexts[i] = this;values[i] = arguments.length > 1?_slice3.call(arguments):value;if(values === progressValues){deferred.notifyWith(contexts,values);}else if(! --remaining){deferred.resolveWith(contexts,values);}};},progressValues,progressContexts,resolveContexts; // Add listeners to Deferred subordinates; treat others as resolved
	...
	data_user.set(elem,key,data);}else {data = undefined;}}return data;}jQuery.extend({hasData:function hasData(elem){return data_user.hasData(elem) || data_priv.hasData(elem);},data:function data(elem,name,_data3){return data_user.access(elem,name,_data3);},removeData:function removeData(elem,name){data_user.remove(elem,name);}, // TODO: Now that all calls to _data and _removeData have been replaced
	// with direct calls to data_priv methods, these can be deprecated.
	...
	event = jQuery.event.fix(event);var i,j,ret,matched,handleObj,handlerQueue=[],args=_slice3.call(arguments),handlers=(data_priv.get(this,"events") || {})[event.type] || [],special=jQuery.event.special[event.type] || {}; // Use the fix-ed jQuery.Event rather than the (read-only) native event
	...
	if(special.postDispatch){special.postDispatch.call(this,event);}return event.result;},handlers:function handlers(event,_handlers3){var i,matches,sel,handleObj,handlerQueue=[],delegateCount=_handlers3.delegateCount,cur=event.target; // Find delegate handlers
	// Black-hole SVG <use> instance trees (#13180)
	// Avoid non-left-click bubbling in Firefox (#3861)
	...
	if(cur.disabled !== true || event.type !== "click"){matches = [];for(i = 0;i < delegateCount;i++) {handleObj = _handlers3[i]; // Don't conflict with Object.prototype properties (#13203)
	...
	if(delegateCount < _handlers3.length){handlerQueue.push({elem:this,handlers:_handlers3.slice(delegateCount)});}return handlerQueue;}, // Includes some event props shared by KeyEvent and MouseEvent
	...
	_statusCode3=s.statusCode || {}, // Headers (they are sent all at once)
	...
	_statusCode3[code] = [_statusCode3[code],map[code]];}}else { // Execute the appropriate callbacks
	...
	jqXHR.statusCode(_statusCode3);_statusCode3 = undefined;if(fireGlobals){globalEventContext.trigger(isSuccess?"ajaxSuccess":"ajaxError",[jqXHR,s,isSuccess?success:error]);} // Complete
	...
	// (#7102#comment:10, https://github.com/jquery/jquery/pull/557)
	// and CommonJS for browser emulators (#13566)
	if(typeof noGlobal === strundefined){window.jQuery = window.$ = jQuery;}return jQuery;}); /***/}, /* 8 */function(module,exports){ /******/"use strict";(function(modules){ // webpackBootstrap
	/******/ // The module cache
	/******/var installedModules={}; /******/ // The require function
	/******/function __webpack_require__(moduleId){ /******/ // Check if module is in cache
	/******/if(installedModules[moduleId]) /******/return installedModules[moduleId].exports; /******/ // Create a new module (and put it into the cache)
	...
	/******/__webpack_require__.c = installedModules; /******/ // __webpack_public_path__
	/******/__webpack_require__.p = ""; /******/ // Load entry module and return exports
	/******/return __webpack_require__(0); /******/})( /************************************************************************/ /******/[function(module,exports,__webpack_require__){__webpack_require__(1);(function webpackMissingModule(){throw new Error("Cannot find module \"index.js\"");})();module.exports = __webpack_require__(8); /***/},function(module,exports,__webpack_require__){'use strict';__webpack_require__(2); /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var Snake=__webpack_require__(6).Snake;var Food=__webpack_require__(5).Food;var canvas=document.getElementById('canvas');var context=canvas.getContext('2d');var board=new Board(600,300);var snake=new Snake(board);var food=new Food(board);function overlay(){var el=document.getElementById("overlay");el.style.visibility = el.style.visibility == "visible"?"hidden":"visible";}$('#play-again').click(function(){console.log("RELOAD GAME");window.location.reload();});var direction='0';requestAnimationFrame(function gameLoop(){context.clearRect(0,0,canvas.width,canvas.height);board.draw(context);food.draw(context);document.onkeydown = function(e){if(e.keyCode === 37 || e.keyCode === 38 || e.keyCode === 39 || e.keyCode === 40){direction = e.keyCode.toString();}};if(snake.collisionAtEdge() || snake.collisionWithSelf(direction)){return overlay();}snake.move(direction);requestAnimationFrame(gameLoop);}); /***/},function(module,exports){'use strict';function Block(board,x,y){this.board = board;this.x = x;this.y = y;this.width = 10;this.height = 10;}Block.prototype.draw = function(context){context.beginPath();context.rect(this.x,this.y,this.width,this.height); // context.arc(this.x, this.y, 10, 0, 2 * Math.PI, false);
	context.fillStyle = 'orange';context.fill();return this;};Block.prototype.blockBelow = function(){return this.board.findBlock(this.x,this.y + 1);};Block.prototype.blockToTheRight = function(){return this.board.findBlock(this.x + 1,this.y);};module.exports = {Block:Block}; /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Food=__webpack_require__(5).Food;function Board(columns,rows){this.columns = columns;this.rows = rows;this.blocks = [];this.food = [];this.score = 0;}Board.prototype.draw = function(context){this.blocks.forEach(function(block){block.draw(context);});};Board.prototype.findBlock = function(x,y){for(var i=0;i < this.blocks.length;i++) {if(this.blocks[i].x === x && this.blocks[i].y === y){return this.blocks[i];}}};Board.prototype.addBlock = function(x,y){var block=new Block(this,x,y);this.blocks.push(block);return block;};Board.prototype.addFood = function(food){this.food.push(food);};module.exports = {Board:Board}; /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var Snake=__webpack_require__(6).Snake; //image = 'mouse.png';
	function Food(board){this.board = board;this.width = 10;this.height = 10;this.setRandomPosition();this.board.addFood(this);}Food.prototype.draw = function(context){context.beginPath();context.arc(this.x,this.y,6,0,2 * Math.PI,false);context.lineWidth = 2;context.fillStyle = 'green';context.fill();return this;};Food.prototype.setRandomPosition = function(){this.x = Math.floor(Math.random() * 560 - 20 + 20);this.y = Math.floor(Math.random() * 260 - 20 + 20);};Food.prototype.wasEaten = function(){this.setRandomPosition();};module.exports = {Food:Food}; /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var $=__webpack_require__(7);function Snake(board){this.board = board;this.body = [new Block(board,40,40)];this.head = this.body[0];this.board.blocks.push(this.head);this.velocity = 3;return this;}Snake.prototype.move = function(direction){if(direction == '38'){ //down
	if(this.canMoveDown()){this.moveOnYAxis(this.velocity * -1);}}else if(direction == '40'){ //up
	if(this.canMoveUp()){this.moveOnYAxis(this.velocity);}}else if(direction == '37'){ //left
	if(this.canMoveLeft()){this.moveOnXAxis(this.velocity * -1);}}else if(direction == '39'){ //right
	if(this.canMoveRight()){this.moveOnXAxis(this.velocity);}}};Snake.prototype.canMoveUp = function(){return !(this.isAtTop() || this.blockBelow());};Snake.prototype.canMoveDown = function(){return !(this.isAtBottom() || this.blockOnTop());};Snake.prototype.canMoveRight = function(){return !(this.isAtRightEdge() || this.blockToTheRight());};Snake.prototype.canMoveLeft = function(){return !(this.isAtLeftEdge() || this.blockToTheLeft());};Snake.prototype.isAtRightEdge = function(){return this.head.x + 10 > this.board.columns;};Snake.prototype.isAtLeftEdge = function(){return this.head.x - 1 < 0;};Snake.prototype.isAtBottom = function(){return this.head.y - 1 < 0;};Snake.prototype.isAtTop = function(){return this.head.y + 10 > this.board.rows;};Snake.prototype.blockToTheLeft = function(){return !!this.board.findBlock(this.head.x - 2,this.head.y);};Snake.prototype.blockToTheRight = function(){return !!this.board.findBlock(this.head.x + 2,this.head.y);};Snake.prototype.blockOnTop = function(){return !!this.board.findBlock(this.head.x,this.head.y - 2);};Snake.prototype.blockBelow = function(){return !!this.board.findBlock(this.head.x,this.head.y + 2);};Snake.prototype.draw = function(){context.fillRect(this.head.x,this.head.y,this.head.width,this.head.height);return this;};Snake.prototype.moveOnXAxis = function(velocity){var snakeLength=this.body.length;for(var i=1;i < snakeLength;i++) {this.body[snakeLength - i].x = this.body[snakeLength - i - 1].x;this.body[snakeLength - i].y = this.body[snakeLength - i - 1].y;}this.head.x += velocity;this.headCheckForFood();};Snake.prototype.moveOnYAxis = function(velocity){var snakeLength=this.body.length;for(var i=1;i < snakeLength;i++) {this.body[snakeLength - i].x = this.body[snakeLength - i - 1].x;this.body[snakeLength - i].y = this.body[snakeLength - i - 1].y;}this.head.y += velocity;this.headCheckForFood();};Snake.prototype.collisionAtEdge = function(){return this.isAtTop() || this.isAtBottom() || this.isAtLeftEdge() || this.isAtRightEdge();};Snake.prototype.collisionWithSelf = function(direction){if(direction === '39' && this.blockToTheRight()){return true;}else if(direction === '37' && this.blockToTheLeft()){return true;}else if(direction === '38' && this.blockOnTop()){return true;}else if(direction === '40' && this.blockBelow()){return true;}};Snake.prototype.headCheckForFood = function(){var xDiff=Math.abs(this.head.x - this.board.food[0].x);var yDiff=Math.abs(this.head.y - this.board.food[0].y);if(xDiff < 10 && yDiff < 10){for(var i=0;i < 15;i++) {this.eat(new Block(this.board,this.body[0].x,this.body[0].y));}this.board.food[0].wasEaten();this.board.score += 100;$('span').text(this.board.score);}};Snake.prototype.eat = function(block){this.body.push(block);this.board.blocks.push(block);};module.exports = {Snake:Snake}; /***/},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__; /*!
			 * jQuery JavaScript Library v2.1.4
			 * http://jquery.com/
			 *
			 * Includes Sizzle.js
	...
	// you try to trace through "use strict" call chains. (#13335)
	//
	var arr=[];var _slice2=arr.slice;var concat=arr.concat;var push=arr.push;var indexOf=arr.indexOf;var class2type={};var toString=class2type.toString;var hasOwn=class2type.hasOwnProperty;var support={};var  // Use the correct document accordingly with window argument (sandbox)
	document=window.document,version="2.1.4", // Define a local copy of jQuery
	jQuery=function jQuery(selector,context){ // The jQuery object is actually just the init constructor 'enhanced'
	// Need init if jQuery is called (just allow error to be thrown if not included)
	return new jQuery.fn.init(selector,context);}, // Support: Android<4.1
	...
	// (You can seed the arguments with an array of args, but this is
	// only used internally.)
	each:function each(callback,args){return jQuery.each(this,callback,args);},map:function map(callback){return this.pushStack(jQuery.map(this,function(elem,i){return callback.call(elem,i,elem);}));},slice:function slice(){return this.pushStack(_slice2.apply(this,arguments));},first:function first(){return this.eq(0);},last:function last(){return this.eq(-1);},eq:function eq(i){var len=this.length,j=+i + (i < 0?len:0);return this.pushStack(j >= 0 && j < len?[this[j]]:[]);},end:function end(){return this.prevObject || this.constructor(null);}, // For internal use only.
	// Behaves like an Array's method, not like a jQuery method.
	push:push,sort:arr.sort,splice:arr.splice};jQuery.extend = jQuery.fn.extend = function(){var options,name,src,copy,copyIsArray,clone,target=arguments[0] || {},i=1,length=arguments.length,deep=false; // Handle a deep copy situation
	if(typeof target === "boolean"){deep = target; // Skip the boolean and the target
	target = arguments[i] || {};i++;} // Handle case when target is a string or something (possible in deep copy)
	...
	// this throws a TypeError, but we will just return undefined.
	if(!jQuery.isFunction(fn)){return undefined;} // Simulated bind
	args = _slice2.call(arguments,2);proxy = function(){return fn.apply(context || this,args.concat(_slice2.call(arguments)));}; // Set the guid of unique handler to the same of original handler, so it can be removed
	proxy.guid = fn.guid = fn.guid || jQuery.guid++;return proxy;},now:Date.now, // jQuery.support is not used in Core but other projects attach their
	// properties to it so it needs to exist.
	support:support}); // Populate the class2type map
	jQuery.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(i,name){class2type["[object " + name + "]"] = name.toLowerCase();});function isArraylike(obj){ // Support: iOS 8.2 (not reproducible in simulator)
	...
	lock:function lock(){stack = undefined;if(!memory){self.disable();}return this;}, // Is it locked?
	locked:function locked(){return !stack;}, // Call all callbacks with the given context and arguments
	fireWith:function fireWith(context,args){if(list && (!_fired2 || stack)){args = args || [];args = [context,args.slice?args.slice():args];if(firing){stack.push(args);}else {fire(args);}}return this;}, // Call all the callbacks with the given arguments
	fire:function fire(){self.fireWith(this,arguments);return this;}, // To know if the callbacks have already been called at least once
	...
	if(data === undefined && elem.nodeType === 1){name = "data-" + key.replace(rmultiDash,"-$1").toLowerCase();data = elem.getAttribute(name);if(typeof data === "string"){try{data = data === "true"?true:data === "false"?false:data === "null"?null: // Only convert to a number if it doesn't change the string
	+data + "" === data?+data:rbrace.test(data)?jQuery.parseJSON(data):data;}catch(e) {} // Make sure we set the data so it isn't changed later
	data_user.set(elem,key,data);}else {data = undefined;}}return data;}jQuery.extend({hasData:function hasData(elem){return data_user.hasData(elem) || data_priv.hasData(elem);},data:function data(elem,name,_data2){return data_user.access(elem,name,_data2);},removeData:function removeData(elem,name){data_user.remove(elem,name);}, // TODO: Now that all calls to _data and _removeData have been replaced
	// with direct calls to data_priv methods, these can be deprecated.
	_data:function _data(elem,name,data){return data_priv.access(elem,name,data);},_removeData:function _removeData(elem,name){data_priv.remove(elem,name);}});jQuery.fn.extend({data:function data(key,value){var i,name,data,elem=this[0],attrs=elem && elem.attributes; // Gets all values
	if(key === undefined){if(this.length){data = data_user.get(elem);if(elem.nodeType === 1 && !data_priv.get(elem,"hasDataAttrs")){i = attrs.length;while(i--) { // Support: IE11+
	// The attrs elements can be null (#14894)
	...
	tmp = elem[ontype];if(tmp){elem[ontype] = null;} // Prevent re-triggering of the same event, since we already bubbled it above
	jQuery.event.triggered = type;elem[type]();jQuery.event.triggered = undefined;if(tmp){elem[ontype] = tmp;}}}}return event.result;},dispatch:function dispatch(event){ // Make a writable jQuery.Event from the native event object
	event = jQuery.event.fix(event);var i,j,ret,matched,handleObj,handlerQueue=[],args=_slice2.call(arguments),handlers=(data_priv.get(this,"events") || {})[event.type] || [],special=jQuery.event.special[event.type] || {}; // Use the fix-ed jQuery.Event rather than the (read-only) native event
	args[0] = event;event.delegateTarget = this; // Call the preDispatch hook for the mapped type, and let it bail if desired
	if(special.preDispatch && special.preDispatch.call(this,event) === false){return;} // Determine handlers
	handlerQueue = jQuery.event.handlers.call(this,event,handlers); // Run delegates first; they may want to stop propagation beneath us
	i = 0;while((matched = handlerQueue[i++]) && !event.isPropagationStopped()) {event.currentTarget = matched.elem;j = 0;while((handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped()) { // Triggered event must either 1) have no namespace, or 2) have namespace(s)
	...
	// (#7102#comment:10, https://github.com/jquery/jquery/pull/557)
	// and CommonJS for browser emulators (#13566)
	if(typeof noGlobal === strundefined){window.jQuery = window.$ = jQuery;}return jQuery;}); /***/},function(module,exports){ /******/"use strict";(function(modules){ // webpackBootstrap
	/******/ // The module cache
	/******/var installedModules={}; /******/ // The require function
	/******/function __webpack_require__(moduleId){ /******/ // Check if module is in cache
	/******/if(installedModules[moduleId]) /******/return installedModules[moduleId].exports; /******/ // Create a new module (and put it into the cache)
	...
	/******/__webpack_require__.c = installedModules; /******/ // __webpack_public_path__
	/******/__webpack_require__.p = ""; /******/ // Load entry module and return exports
	/******/return __webpack_require__(0); /******/})( /************************************************************************/[function(module,exports,__webpack_require__){__webpack_require__(1);(function webpackMissingModule(){throw new Error("Cannot find module \"index.js\"");})(); /***/},function(module,exports,__webpack_require__){'use strict';__webpack_require__(2); /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var Snake=__webpack_require__(6).Snake;var Food=__webpack_require__(5).Food;var canvas=document.getElementById('canvas');var context=canvas.getContext('2d');var board=new Board(600,300);var snake=new Snake(board);var food=new Food(board);function overlay(){var el=document.getElementById("overlay");el.style.visibility = el.style.visibility == "visible"?"hidden":"visible";}$('#play-again').click(function(){console.log("RELOAD GAME");window.location.reload();});var direction='0';requestAnimationFrame(function gameLoop(){context.clearRect(0,0,canvas.width,canvas.height);board.draw(context);food.draw(context);document.onkeydown = function(e){if(e.keyCode === 37 || e.keyCode === 38 || e.keyCode === 39 || e.keyCode === 40){direction = e.keyCode.toString();}};if(snake.collisionAtEdge() || snake.collisionWithSelf(direction)){return overlay();}snake.move(direction);requestAnimationFrame(gameLoop);}); /***/},function(module,exports){'use strict';function Block(board,x,y){this.board = board;this.x = x;this.y = y;this.width = 10;this.height = 10;}Block.prototype.draw = function(context){context.beginPath();context.rect(this.x,this.y,this.width,this.height); // context.arc(this.x, this.y, 10, 0, 2 * Math.PI, false);
	context.fillStyle = 'orange';context.fill();return this;};Block.prototype.blockBelow = function(){return this.board.findBlock(this.x,this.y + 1);};Block.prototype.blockToTheRight = function(){return this.board.findBlock(this.x + 1,this.y);};module.exports = {Block:Block}; /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Food=__webpack_require__(5).Food;function Board(columns,rows){this.columns = columns;this.rows = rows;this.blocks = [];this.food = [];this.score = 0;}Board.prototype.draw = function(context){this.blocks.forEach(function(block){block.draw(context);});};Board.prototype.findBlock = function(x,y){for(var i=0;i < this.blocks.length;i++) {if(this.blocks[i].x === x && this.blocks[i].y === y){return this.blocks[i];}}};Board.prototype.addBlock = function(x,y){var block=new Block(this,x,y);this.blocks.push(block);return block;};Board.prototype.addFood = function(food){this.food.push(food);};module.exports = {Board:Board}; /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var Snake=__webpack_require__(6).Snake; //image = 'mouse.png';
	function Food(board){this.board = board;this.width = 10;this.height = 10;this.setRandomPosition();this.board.addFood(this);}Food.prototype.draw = function(context){context.beginPath();context.arc(this.x,this.y,6,0,2 * Math.PI,false);context.lineWidth = 2;context.fillStyle = 'green';context.fill();return this;};Food.prototype.setRandomPosition = function(){this.x = Math.floor(Math.random() * 560 - 20 + 20);this.y = Math.floor(Math.random() * 260 - 20 + 20);};Food.prototype.wasEaten = function(){this.setRandomPosition();};module.exports = {Food:Food}; /***/},function(module,exports,__webpack_require__){'use strict';var Block=__webpack_require__(3).Block;var Board=__webpack_require__(4).Board;var $=__webpack_require__(7);function Snake(board){this.board = board;this.body = [new Block(board,40,40)];this.head = this.body[0];this.board.blocks.push(this.head);this.velocity = 3;return this;}Snake.prototype.move = function(direction){if(direction == '38'){ //down
	if(this.canMoveDown()){this.moveOnYAxis(this.velocity * -1);}}else if(direction == '40'){ //up
	if(this.canMoveUp()){this.moveOnYAxis(this.velocity);}}else if(direction == '37'){ //left
	...
	/***/} /******/]); /***/ /***/ /***/ /***/ /***/ /***/ /***/ /***/ // Otherwise append directly
	/***/ /* 0 */ /* 1 */ /* 2 */ /* 3 */ /* 4 */ /* 5 */ /* 6 */ /* 7 */ /***/} /******/]); /***/ /***/ /***/ /***/ /***/ /***/ /***/ /***/ // Otherwise append directly
	/***/ /* 0 */ /* 1 */ /* 2 */ /* 3 */ /* 4 */ /* 5 */ /* 6 */ /* 7 */ /* 8 */ /******/
